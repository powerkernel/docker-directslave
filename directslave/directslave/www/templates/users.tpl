    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <form class="navbar-form navbar-right"  action="/dashboard/users" method="post">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <li><a href="/dashboard/domains">Domains</a></li>
            <li class="active"><a href="/dashboard/users">Manage Users</a></li>
            <li><a href="/dashboard/logs">Log Files</a></li>
          </ul>
          <ul class="nav nav-sidebar">
            <li><a href="/logout">Logout</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          {{ if .Pager }}
          <form action="/dashboard/users" id="pageForm" method="get">
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <form action="/dashboard/users/save" method="post">
                <tr>
              ...
              {{ range .Users }}
                ...
                <tr>
                  ...
                  <td>{{ .Password }}</td>
                  <td>
                    <a href="/dashboard/users/edit?user={{ .UserName }}" style="font-size: 18px;" class="glyphicon glyphicon-edit"></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="/dashboard/users/remove?user={{ .UserName }}" style="font-size: 18px;" class="glyphicon glyphicon-remove"></a>
                  </td>
                </tr> 
